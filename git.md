...
git checkout<branch-name> - checkout to a particular branch
git checkout -b <branch-name> - create a new branch from the current branch and checkout to it
git remote add origin https://github.com/AnjaliVishwakarma33/fullstack-track
git push -u(upstream) origin <branch-name>
git pull
git merge <branch-name>
git branch -D <bramch-name>
git clone <url>
